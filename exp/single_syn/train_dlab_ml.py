...
# We use pascal as the test set for multi-dataset pretrain
def validation(net_, testloader, testloader_flip, epoch, writer, criterion, classes=7):
	running_loss_ts = 0.0
	miou = 0
...
def main(opts):
	...
	# Network definition
	net_ = deeplab_xception_synBN.DeepLabv3_plus_multi_set(n_classes=opts.classes, os=16, pretrained=True)
